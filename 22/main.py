...
if __name__ == "__main__":
    ...
    if not simulation:
        ...
        for i in xrange(10000000):
            ...
            #print fight.outcome
            #print fight.attacker.moves
            if "wizard has won" in fight.outcome:
                print "\n"+fight.outcome
                print fight.attacker.name, fight.attacker.mana_spent, fight.attacker.moves
                print fight.defender.name, fight.defender.mana_spent, fight.defender.moves
                if fight.defender.name == "wizard":
                    mp_spent = fight.defender.mana_spent
                    moves = fight.defender.moves
                elif fight.attacker.name == "wizard":
                    mp_spent = fight.attacker.mana_spent
                    moves = fight.defender.moves
